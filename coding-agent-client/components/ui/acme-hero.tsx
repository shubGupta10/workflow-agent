        ...
        <div className="w-full">
            <section className="w-full py-8 md:py-12 lg:py-16">
                ...
                >
                    ...
                    <motion.p
                        className="mx-auto max-w-2xl text-lg sm:text-xl md:text-2xl text-muted-foreground"
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
                    ...
                    >
                        ...
                        ,{" "}
                        <span className="font-semibold text-foreground">issue fixes</span>
                        , and{" "}
                        <span className="font-semibold text-foreground">change planning</span>
                    </motion.p>
                    <motion.div
