        ...
        task._id,
        {
            $push: {
                timeline: {
                    role: 'system',
                    type: 'task_created',
                    content: `Task created for repository: ${repoUrl}`,
                    createdAt: new Date()
                }
            }
        }
        ...
        taskId,
        {
            $push: {
                timeline: {
                    ...
                    type: 'action_set',
                    content: `User set action: ${action}`,
                    createdAt: new Date()
                }
            }
        }
        ...
        taskId,
        {
            $push: {
                timeline: {
                    ...
                    type: existingTask.action === TaskAction.REVIEW_PR ? 'pr_review_generated' : 'plan_generated',
                    content: existingTask.action === TaskAction.REVIEW_PR ? 'PR review generated by agent' : 'Plan generated by agent',
                    createdAt: new Date()
                }
            }
        }
...
const executeTask = async (taskId: string) => {
    ...
    try {
        ...
        existingTask.timeline.push({
            role: TimelineEnum.AGENT,
            type: 'task_executed',
            content: `Task executed successfully. PR created: ${prUrl}`,
            createdAt: new Date()
        })
